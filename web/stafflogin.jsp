<%-- 
    Document   : stafflogin
    Created on : Nov 10, 2017, 1:00:00 PM
    Author     : Kruthi
--%>
...
<div class="relative">
  <form method="post" action="stafflogin1.jsp">
      <h4><font color="#2f4f4f"> <b>Staff Login:</b></font></h4>
<div class="imgcontainer">
  ...
  <div class="formD">
    ...
    <br>
  <input type="password" placeholder="Enter Password" name="spw" required>
  <br><br>
