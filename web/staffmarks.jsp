<%-- 
    Document   : staffmarks
    Created on : Nov 11, 2017, 1:59:09 AM
    Author     : Kruthi
--%>
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <div id="myacc" class="container-fluid">
            ...
            <table id="details" width="60%"> 
                <br><br><caption><h4><b>Marks:</b></h4></caption>
